    ...
    <>
      ...
      <div className='flex flex-wrap items-center justify-center mt-16 gap-8'>
        <div className='flex flex-col items-center max-w-[300px] sm:max-w-[100%]'>
          <Image
            ...
            width={381}
            height={480}
            className="max-w-[100%] h-auto hover:scale-105"
          />
      ...
      <div>
        ...
        <div className='flex items-center justify-center mt-6'>
          <Link href={"/product"}>
          <button className="w-[245px] h-[48px] bg-[#FFFFFF] border border-[#B88E2F] text-[#B88E2F] hover:bg-[#B88E2F] hover:text-white">
            Show More
          </button>
          </Link>
        </div>
        ...
        <div className="h-auto mt-32 px-6 md:px-16 lg:px-32">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-4 mt-8">
            ...
            <div className="flex h-[392px] w-[295px] justify-center">
              <Image
            ...
            <div className="flex mb-52 w-[425px] h-[423px] justify-center">
              <Image
