    ...
    return (
        ...
        />
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 mx-auto max-w-screen-xl mt-8'>
                <div className='w-[285px] h-[446px] bg-[#F4F5F7] mx-auto hover:scale-110'>
                    <Image
                ...
                <div className='relative w-[285px] h-[446px] bg-[#F4F5F7] mx-auto hover:scale-110'>
                    <Image
                    ...
                    <div className='absolute inset-0 bg-[#3A3A3A] bg-opacity-60 flex items-center justify-center flex-col'>
                        ...
                        <div className='flex items-center justify-around gap-4 mt-6 text-[#FFFFFF] hover:scale-110'>
                            <Image
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 mx-auto max-w-screen-xl mt-8'>
                <div className='w-full h-[446px] bg-[#F4F5F7] mx-auto flex flex-col items-center hover:scale-110'>
                    <Image
                        src={"/images/table.png"}
                        alt='table-img'
                        width={285}
                ...
                <div className='relative w-full h-[446px] bg-[#F4F5F7] mx-auto flex flex-col items-center hover:scale-110'>
                    <Image
                        src="/images/chair.png"
                        alt="chair-img"
                        width={285}
            ...
            <div className='flex items-center justify-center gap-8 mt-14'>
                <button className='w-[60px] h-[60px] bg-[#B88E2F] text-white flex items-center justify-center'>1 </button>
                <button className='w-[60px] h-[60px] bg-[#F9F1E7] flex items-center justify-center hover:bg-[#B88E2F] hover:text-white'>2</button>
